...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/teacher/createMeetLinkage.css" /> 
    </head>
                           ...
                           <form method="POST">
                            <h2>Create Meet Linkage</h2>
                                ...
                                <p align="right" style="margin-right: 3%; margin-top: 5%;">
                                    ...
                                    <button type="submit" class="btn btn-primary" style="padding: 6px 21px;">Link</button>
                                </p>
                           </form>   
                        </div>
                    </div>
